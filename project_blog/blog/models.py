...
class Tag(models.Model):
    name = models.CharField(max_length=50,verbose_name='标签的名字')
...
class Comment(models.Model):
    dontent = models.TextField(verbose_name='评论内容')
    date_publish = models.DateField(auto_now_add=True, verbose_name='发布时间')
    user = models.ForeignKey(User, verbose_name='用户')
...
class Links(models.Model):
    ...
    index = models.IntegerField(default=999,verbose_name='排列循序(从小到大)')
